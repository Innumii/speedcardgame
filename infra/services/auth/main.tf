...
locals {
  ...
  cards_service_base_url_secret_arn = var.cards_service_base_url_secret_arn != null ? var.cards_service_base_url_secret_arn : try(local.data_outputs.auth_runtime_secret_arn, null)
